...
public class InputParser {
    ...
    public void parseInput(String input) {
        ...
        try {
            if(input.split("(")[0] == "add_user") {
            ...
            } else if (input.split("(")[0] == "add_driver") {
                ...
                Float Y = Float.parseFloat(input.split(",")[6].substring(1, input.split(",")[6].length() - 2));
                cabBookingController.addDriver(name, gender, age, vehicleName, vehicleNumber, Pair.of(X, Y));
            } else if (input.split("(")[0] == "update_userLocation") {
            ...
            } else if (input.split("(")[0] == "update_user") {
                cabBookingController.updateUser(input.split("\"")[1], input.split("\"")[3]);
            } else if (input.split("(")[0] == "update_driverLocation") {
                cabBookingController.updateDriverLocation(input.split("\"")[1]);
            } else if (input.split("(")[0] == "change_driver_status") {
                cabBookingController.changeDriverStatus(input.split("\"")[1], Boolean.parseBoolean(input.split("\"")[3]));
            } else if (input.split("(")[0] == "find_ride") {
                String userName = input.split("\"")[1];
            ...
            } else if (input.split("(")[0] == "choose_ride") {
                cabBookingController.chooseRide(input.split("\"")[1], input.split("\"")[3]);
            } else if (input.split("(")[0] == "calculateBill") {
                cabBookingController.calculateBill(input.split("\"")[1]);
            } else if (input.split("(")[0] == "find_total_earning") {
